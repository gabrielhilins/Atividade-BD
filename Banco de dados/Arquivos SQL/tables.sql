...
CREATE TABLE Sala (
    ...
    serie VARCHAR(255),
    cod_escola INT,
    PRIMARY KEY (num_sala, serie, cod_escola),
...
CREATE TABLE Matricula (
    ...
    ano_letivo INT,
    PRIMARY KEY (id_aluno, cod_escola, num_sala, serie, ano_letivo),
    FOREIGN KEY (id_aluno) REFERENCES Aluno(id_aluno),
    FOREIGN KEY (cod_escola, num_sala, serie) REFERENCES Sala(cod_escola, num_sala, serie)
);
...
CREATE TABLE Resultados (
    ...
    FOREIGN KEY (id_aluno, cod_escola, num_sala, serie, ano_letivo) REFERENCES Matricula(id_aluno, cod_escola, num_sala, serie, ano_letivo)
 );
...
CREATE TABLE Professores (
    ...
    PRIMARY KEY (cpf, cod_escola),
    FOREIGN KEY (cod_escola, serie, nu_sala) REFERENCES Sala(cod_escola, serie, num_sala),
    FOREIGN KEY (id_func, cod_escola) REFERENCES Funcionario(id_func, cod_escola),
