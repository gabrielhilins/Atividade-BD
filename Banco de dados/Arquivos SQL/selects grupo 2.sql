...
-- 2. busque o id e as notas dos alunos que as notas são maiores que 8
select r.id_aluno, r.nota
from resultados r
left join matricula m on r.id_aluno = m.id_aluno
where r.nota > 8;

-- 3. mostre as disciplinas e a quantidade de professores de cada uma
Select d.nome_disciplina, count(p.cpf) as qtd_professores
From disciplinas d
join professores p on d.cod_disciplina = p.cod_disciplina
group by d.nome_disciplina;

-- 4. busque o nome, o id e o codigo da disciplina de todos os professores
...
-- 5. calcule a media de notas por série e exiba a serie
...
-- 6. liste os nomes das escolas que tem acesso a internet (0 = não tem, 1 = tem)
...
-- 7. mostre o nome, o id e a sala de todos os alunos negros
...
-- 8. mostre o nome, a sala e a nota dos alunos que foram
...
-- 9. Liste o nome dos professores, em ordem alfabetica, e suas disciplinas que
